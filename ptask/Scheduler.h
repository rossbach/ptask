...
namespace PTask {
    ...
    protected:
        ...
        static BOOL IsDenyListed(Accelerator * pAccelerator);

        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Query if 'pAccelerator' is allow listed. </summary>
        ///
        /// <remarks>   crossbac, 6/19/2014. </remarks>
        ///
        /// <param name="pAccelerator"> [in,out] If non-null, the accelerator. </param>
        ...
        static BOOL IsAllowListed(Accelerator * pAccelerator);
        ...
        /// <summary> deny/allow lists of platform specific device ids whose
        ///           entries represent DisableAccelerator calls before 
        ///           runtime initialization. 
        ///           </summary>
        static std::map<ACCELERATOR_CLASS, std::set<int>*> s_vDenyListDeviceIDs;
        static std::map<ACCELERATOR_CLASS, std::set<int>*> s_vAllowListDeviceIDs;
